...
public class SnakeAndLadderBoard {
    ...
    public void removePlayer(SnakeAndLadder.models.Player player){
        players.remove(player.getId());
    }

    public int getPlayerCurrPos(SnakeAndLadder.models.Player player){
        return players.get(player.getId());
    }

    public void setPalyerPosition(SnakeAndLadder.models.Player player, int position){
